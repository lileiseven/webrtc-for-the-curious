...
Even a small deviation would produce unreliable transmission time measurement.
...
Half of round trip time is considered to be a good enough approximation of transmission time.
This workaround is not without drawbacks. 
It makes an assumption that it takes equal amount of time to send and receive packets.
